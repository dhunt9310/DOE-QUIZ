...
<section>
	...
	<div id="quiz">
		...
		<!-- Quiz Header -->
		<h2>Tutorial 16: How do I put my team in place?</h2>
		...
		<!-- Question 4 -->
		<form class="show">
	    <p id="one"><h2><span>4</span>Which of the following are reasonable places to identify team members for your SBIR/STTR project?</h2><br />
	        <div class="tab">
	            <input type="radio" name="question" value="A" /><span>(a) www.sbir.gov</span><br />
	            <input type="radio" name="question" value="B" /><span>(b) Conference proceedings</span><br />
	    ...
	    <p id="one"><h2><span>5</span>Which of the following statements is inaccurate?</h2><br />
	        <div class="tab">
	            <input type="radio" name="question" value="A" /><span>(a) Choose team members with whom you are sure you can work well.</span><br />
