<script type="text/javascript">
  var answers = [
  	"(b) False", "C",
  	"(b) The Letter of Intent is uploaded to the grants.gov website.", "C",
  	"(a) True", "C",
  	"(a) As an attachment to Field 12 of the Research & Related: Other Project Information form", "C",
  	"(c) You cannot ask DOE to consider your Phase I proposal for both SBIR and STTR funding.", "C",
  ];
</script>
	...
	<div id="quiz">
	    ...
	    <p id="one"><h2><span>2</span>Which of the following statements is NOT accurate?</h2><br />
	        <div class="tab">
	            ...
	            <input type="radio" name="question" value="C" /><span>(b) The Letter of Intent is uploaded to the grants.gov website.</span><br />
	    ...
	    <p id="one"><h2><span>4</span>Where should the mandatory Phase I Commercialization Plan be included in your application?</h2><br />
	        <div class="tab">
	            <input type="radio" name="question" value="C" /><span>(a) As an attachment to Field 12 of the Research & Related: Other Project Information form</span><br />
	    ...
	    <p id="one"><h2><span>5</span>Which of the following statements is inaccurate?</h2><br />
	        <div class="tab">
	            ...
	            <input type="radio" name="question" value="C" /><span>(c) You cannot ask DOE to consider your Phase I proposal for both SBIR and STTR funding.</span><br />
