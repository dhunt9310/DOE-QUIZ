<script type="text/javascript">
  var answers = [
      "(c) SBIR pays for marketing expenses to bring the SBIR funded technology to market.", "C",
      "(b) Two", "C",
      "(d) Only by the date specified in the FOA if one has also submitted an LOI on time", "C", 
      "(b) $150K", "C",
      "(d) The dates for webinars on the various topics", "C",    
  ];
</script>
	...
	<div id="quiz">
	    ...
	    <p id="one"><h2><span>2</span>How many Funding Opportunity Announcements (FOA) does the DOE SBIR/STTR program office typically have each year?</h2><br />
	        <div class="tab">
	            ...
	            <input type="radio" name="question" value="C" /><span>(b) Two</span><br />
	            <input type="radio" name="question" value="B" /><span>(c) Three</span><br />
	    ...
	    <p id="one"><h2><span>3</span>Which of the following is a true statement regarding when applicants can submit a proposal to the DOE SBIR/STTR program office?</h2><br />
	        <div class="tab">
	            <input type="radio" name="question" value="A" /><span>(a) Any time of the year</span><br />
	            <input type="radio" name="question" value="B" /><span>(b) Only by the date specified in the FOA</span><br />
	            <input type="radio" name="question" value="D" /><span>(c) June 1st</span><br />
	    ...
	    <p id="one"><h2><span>4</span> What is the most common size of a Phase I SBIR award from DOE?</h2><br />
	        <div class="tab">
	            ...
	            <input type="radio" name="question" value="C" /><span>(b) $150K</span><br />
	            <input type="radio" name="question" value="B" /><span>(c) $250K</span><br />
	            <input type="radio" name="question" value="D" /><span>(d) $350K</span><br />
	        </div>
	    </p>
	    <div class="next">Next Question</div>
		</form>
	    ...
	    <p id="one"><h2><span>5</span>What is the major difference between the SBIR and STTR programs?</h2><br />
	        <div class="tab">
	            ...
	            <input type="radio" name="question" value="B" /><span>(b) An FFRDC can apply for an STTR award.</span><br />
	            <input type="radio" name="question" value="D" /><span>(c) The STTR program will reimburse a company for research already conducted.</span><br />
	    ...
	    <p id="one"><h2><span>6</span> The following is NOT found in the list of DOE Topics when released?</h2><br />
	        <div class="tab">
	            ...
	            <input type="radio" name="question" value="B" /><span>(b) A description of the topics of interest</span><br />
	            <input type="radio" name="question" value="D" /><span>(c) A schedule of important dates</span><br />
	            <input type="radio" name="question" value="C" /><span>(d) The dates for webinars on the various topics</span><br />
	        </div>
	    </p>
	    <div class="next">Next Question</div>
		</form>
<div id="buttonDiv_six">        
